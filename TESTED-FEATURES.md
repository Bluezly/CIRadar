# Tested features — 1.3.2 OSS RC.14
...
- tenant isolation, RBAC, API keys, audit events, OAuth/OIDC, Slack workspace-to-tenant binding, SAML replay/strict validation, and `xmlsec1` executable pinning
- Extended Query Protocol parameter binding, SCRAM state/size bounds, and guards against manual SQL-literal helpers in PostgreSQL storage code
...
- notification delivery, deduplication, repair-PR and automatic-quarantine events, ChatOps, and provider payload rendering
